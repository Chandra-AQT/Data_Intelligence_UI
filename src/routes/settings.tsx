...
function Settings() {
  ...
  const user = getUser() ?? { full_name: "DocLens Operator", email: "operator@doclens.ai" };
        ...
        <div className="rounded-2xl p-6" style={CARD}>
          ...
          {tab === "About" && (
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-2xl font-black text-white">DocLens AI</h2>
                <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.4)" }}>Document Intelligence · Version 2.0 · ADE Edition</p>
              </div>
