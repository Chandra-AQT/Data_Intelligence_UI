        ...
        <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          ...
          {!collapsed && (
            <div className="min-w-0">
              <p className="text-sm font-black text-white leading-none">DocLens</p>
              <p className="text-[10px] font-bold tracking-widest uppercase mt-0.5" style={{ color: "#22d3ee" }}>AI</p>
            </div>
          )}
        </Link>
      </div>
